CREATE DATABASE  IF NOT EXISTS `control_vehiculos` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
CREATE TABLE `alertas` (
  ...
  `km` char(6) DEFAULT NULL,
  `dias` char(3) DEFAULT NULL,
  `meses` char(3) DEFAULT NULL,
...
--
-- Table structure for table `distribucion_alertas`
--

DROP TABLE IF EXISTS `distribucion_alertas`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `distribucion_alertas` (
  `idAlertas` int(11) NOT NULL,
  `idPlandemantenimiento` int(11) NOT NULL,
  `mail` varchar(60) NOT NULL,
  `mensaje` text,
  KEY `fk_plan_idx` (`idPlandemantenimiento`),
  KEY `fk_alerta_idx` (`idAlertas`),
  CONSTRAINT `fk_alerta` FOREIGN KEY (`idAlertas`) REFERENCES `alertas` (`idalertas`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_plan` FOREIGN KEY (`idPlandemantenimiento`) REFERENCES `planmantenimiento` (`idplanMantenimiento`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='	';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `distribucion_alertas`
--

LOCK TABLES `distribucion_alertas` WRITE;
/*!40000 ALTER TABLE `distribucion_alertas` DISABLE KEYS */;
/*!40000 ALTER TABLE `distribucion_alertas` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `partesporplanmantenimiento` (
  ...
  PRIMARY KEY (`idPlanMantenimiento`,`idPartes`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='		';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2015-12-18 11:01:13
